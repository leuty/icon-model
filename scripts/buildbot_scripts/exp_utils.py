...
def rmexp(
    ...
    thisList.remove_experiments(
        experiment_names,
        builders=builders,
        machines=machines,
        with_config=with_configureflags,
        without_config=without_configureflags,
    )
...
def adddep(
    ...
    thisList.add_dependency_manager(
        from_experiment,
        to_experiment,
        from_builder,
        to_builder,
