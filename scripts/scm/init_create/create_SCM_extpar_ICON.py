...
file_ext_scm = (
    icon_dir + data_dir + "extpar_Torus_Triangles_4x4_2500m_" + location + ".nc"
)
...
var = nc_tid.createVariable(
    "LU_CLASS_FRACTION", np.float64, ("nclass_lu", "cell")
)
for n in range(npts):
    var[:, n] = LU_CLASS_FRACTION
