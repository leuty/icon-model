...
# file_out = icon_dir + data_dir + 'init_SCM_GASS_DCP_GoAmazon_IOP1.nc'

# file_in  = '/hpc/uwork/mkoehler/projects/GASS_DCP_SCM/forcing_GOAmazon/forcing_goamazon_2014.nc'
# file_out = icon_dir + data_dir + 'init_SCM_GASS_DCP_GoAmazon_2014.nc'

yyyy = "2015"
file_in = (
    "/hpc/uwork/mkoehler/projects/GASS_DCP_SCM/forcing_SGP_new/forcing_sgp_new_AMJJAS_"
    + yyyy
    + ".nc"
)
file_out = icon_dir + data_dir + "init_SCM_GASS_DCP_SGP_" + yyyy + ".nc"
...
thlls = (
    nc_fid.variables["divT"][:, 0:nlev, 0, 0]
) / exn  # simplification according to the ICON code, see mo_ls_forcing
