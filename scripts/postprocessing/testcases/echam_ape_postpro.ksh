...
Model=ECHAM
EXP=rc2-2172_ape_qobs_RH75
exp_config="$Model APE w/o O3"  # String will show up in the plot

horizontal_resolution=T63
vertical_resolution=L31

model_data_path=/scratch/work/mh0287/hwan/exps/icon-dev/output_201007_port_phy/echam/aclc/$EXP/
