...
def compute_decomposition(mpi_procs, opnemp_threads):
    ...
    print(
        "  Per domain:  own edges=", owned_edges, " own vertices=", owned_verts
    )
    print("==========================")
    # ------------------------------------------------------------------------------
...
def compute_icon_standard_size(grid_refine_root, grid_refine_level):
    ...
    verts = (
        10 * grid_refine_root * grid_refine_root
    ) * 4**grid_refine_level + 2
