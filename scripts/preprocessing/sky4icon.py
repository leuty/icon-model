...
def main():
    ...
    try:
        ...
        parser.add_argument(
            "startdate",
            help="start date [YYYYMMDDhh, YYYYMMDDhhmm, YYYYMMDDhhmmss]",
        )
        parser.add_argument(
            "enddate",
            help="end date [YYYYMMDDhh, YYYYMMDDhhmmss]",
            nargs="?",
            default="startdate",
        )
        parser.add_argument(
            "--increment", help="increment time span [h]", default=24
        )
        parser.add_argument(
            "--mode",
            help="mode: "
        ...
        while cur_date <= enddate:
            ...
            datestr_3 = datetime.datetime.strftime(
                cur_date - delta_3h, DATEFMT
            )  # = "cur_date - 3h"
            print("date: ", datestr)
            # calculate current day, 00UTC:
            cur_date_00 = cur_date.replace(
            ...
            if not args.ensemble:
                ...
                cat_fg_eu = (
                    "icoeue_pre_fc_rout  letype=101 enum=" + args.emember
                )
            ...
            #
            req_filename = (
                os.environ["TMPDIR"] + "/skyreq_" + datestr + "00R_G+N"
            )
            ...
            if args.mode == MODE_IAU:
                f.write(
                    (
                        ...
                        + "cat="
                        + cat
                        + "       d={0} gptype=201   f=igaf{0}R.grb  p=u,v,t,p,qv                                \n"
                    ).format(datestr)
                )
                f.write(
                    (
                        ...
                        + "cat="
                        + cat
                        + "       d={0} gptype={1}   f=igaf{0}R.grb  p=t_so,t_sea,fr_ice,h_ice,t_ice             \n"
                ...
                if read_w_so:
                    f.write(
                        (
                            ...
                            + "cat="
                            + cat
                            + "   d={0} gptype=201   f=igaf{0}R.grb  p=w_so "
                            + lin
                            + "                              \n"
                        ).format(datestr)
                    )
                f.write(
                    (
                        ...
                        + "cat="
                        + cat
                        + "       d={0} gptype=201   f=igaf{0}R.grb  p=freshsnw,h_snow                           \n"
                    ).format(datestr)
                )
                f.write(
                    (
                        ...
                        + "cat="
                        + cat_fg
                        + "    d={0} s[s]=5400    f=igfff{0}-0130R.grb  lvt1=!100                             \n"
                    ).format(datestr_3)
                )
                f.write(
                    (
                        ...
                        + "cat="
                        + cat_eu
                        + "    d={0} gptype=0     f=ieaf{0}R.grb  p=t_so,t_sea,fr_ice,h_ice,t_ice             \n"
                    ).format(datestr)
                )
                f.write(
                    (
                        ...
                        + "cat="
                        + cat_eu
                        + "    d={0} gptype=201   f=ieaf{0}R.grb  p=w_so "
                        + lin
                        + "                              \n"
                    ).format(datestr)
                )
                f.write(
                    (
                        ...
                        + "cat="
                        + cat_eu
                        + "    d={0} gptype=201   f=ieaf{0}R.grb  p=freshsnw,h_snow                           \n"
                    ).format(datestr)
                )
                f.write(
                    (
                        ...
                        + "cat="
                        + cat_fg_eu
                        + " d={0} s[s]=5400    f=iefff{0}-0130R.grb  lvt1=!100                             \n"
                    ).format(datestr_3)
                )
                ...
                if read_w_so:
                    f.write(
                        (
                            ...
                            + "cat="
                            + cat
                            + "   d={0} gptype=0     f=igaf{0}R.grb p=w_so "
                            + lin
                            + "                               \n"
                        ).format(datestr)
                    )
                f.write(
                    (
                        ...
                        + "cat="
                        + cat
                        + "       d={0} gptype=0     f=igaf{0}R.grb p=w_snow,t_snow,w_i,rho_snow,freshsnw,h_snow \n"
                    ).format(datestr)
                )
                f.write(
                    (
                        ...
                        + "cat="
                        + cat_vv0
                        + "       d={0} s[s]=0  f=igfff{0}-0300R.grb p=hhl                             \n"
                    ).format(datestr)
                )
                f.write(
                    (
                        ...
                        + "cat="
                        + cat_fg
                        + "    d={0} s[s]=10800   f=igfff{0}-0300R.grb lvt1=!100                              \n"
                    ).format(datestr_3)
                )
                f.write(
                    (
                ...
                f.write(
                    (
                        ...
                        + "cat="
                        + cat_eu
                        + "    d={0} gptype=0     f=ieaf{0}R.grb p=w_so "
                        + lin
                        + "                               \n"
                    ).format(datestr)
                )
                f.write(
                    (
                        ...
                        + "cat="
                        + cat_eu
                        + "    d={0} gptype=0     f=ieaf{0}R.grb p=w_snow,t_snow,w_i,rho_snow,freshsnw,h_snow \n"
                    ).format(datestr)
                )
                f.write(
                    (
                        ...
                        + "cat="
                        + cat_vv0_eu
                        + "    d={0} s[s]=0     f=iefff{0}-0300R.grb p=hhl          \n"
                    ).format(datestr)
                )
                f.write(
                    (
                        ...
                        + "cat="
                        + cat_fg_eu
                        + " d={0} s[s]=10800   f=iefff{0}-0300R.grb lvt1=!100                              \n"
                    ).format(datestr_3)
                )
            else:
