...
def main():
    ...
    p.add_option(
        "--date", "-d", default="2012050100", help="requested date YYYMMDDHH"
    )
    ...
    p.add_option(
        ...
        "-a",
        default="printdate",
        help="requested type of output: printdate/weekday/printfmt/endofmonth/fmt",
    )
    p.add_option(
        "--fmt", "-f", default="", help="requested date format (action=fmt)"
    )
    #
