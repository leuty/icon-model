...
| [ECCODES](https://confluence.ecmwf.int/display/ECC) (Fortran interface) | `--enable-grib2` or `--enable-emvorado` | `FCFLAGS='-I/path/to/eccodes/include' LDFLAGS='-L/path/to/eccodes/lib' LIBS='-leccodes_f90'` |
