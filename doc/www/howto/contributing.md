...
Please follow the [ICON development workflow](overview.md) decription. In that process your contributions will be evaluated according to the [Reviewing Guidelines](reviewing.md).
...
1. Blend-in with whatever you change or add to the ICON. Possibly even improve
   ...
   should be similar to other code in the corresponding module. See [^1] and
   [^2] for basic guidelines.
...
[^2]: _[This document](https://gitlab.dkrz.de/icon/icon-model/-/blob/release-2024.01-public/doc/style/icon_standard.pdf?ref_type=heads) might provide some hints on coding style, although some parts of the document are outdated._
