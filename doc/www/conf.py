...
extensions = [
    'myst_parser','sphinx_design' #, 'sphinx_favicon' #Markdown adjustments
]

myst_heading_anchors = 4

myst_enable_extensions = [
    "deflist","colon_fence","substitution"
]
...
html_theme_options = {
  ...
  "icon_links": [
        {"name": "icon-model.org", "url": "https://icon-model.org", "icon": "fas fa-home"}
    ],
  "logo": {
