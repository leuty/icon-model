...
\hline
range\_dustyci\_crit&
R&
20.0&
$\mu$g/kg&
Variability range of threshold for the specific mass concentration of mineral dust
for dusty cirrus parameterization &
dusty cirrus parameterization, i.e. lart\_dusty\_cirrus = .true.
\tabularnewline
...
0.1&
&
Variability range of threshold for the ice saturation ratio for dusty cirrus parameterization &
dusty cirrus parameterization, i.e. lart\_dusty\_cirrus = .true.
\tabularnewline
...
0&
 &
0: off \\
1: simple coupling between autoconversion and Tegen aerosol climatology; requires irad\_aero=6 or 9 \\
...
1: ice nucleating particles concentration defined by temperature and dust concentration from CAMS climatology using DeMott (2015) formula; requires irad\_aero=7 \\
2: ice nucleating particles concentration defined by temperature and dust concentration from Tegen climatology using DeMott (2015) formula; requires irad\_aero=6
\tabularnewline
...
7: CAMS 3D aerosol climatology, the filename can be specified via cams\_clim\_filename in \&radiation\_nml\\
...
%\hline
cams\_clim\_filename &
C&
"CAMS\_clim\_ \\
R<nroot0>B<jlev>\_ \\
DOM<idom>.nc"&
&
Path to the file containing CAMS 3D climatology data\\
Data can be prepared using the script scripts/preprocessing/ \\ make\_camsclim\_onICONgrid.sh 
& inwp\_radiation=4 (ecRad)\\
irad\_aero=7 (CAMS 3D climatology)
\tabularnewline
