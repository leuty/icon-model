...
\tabularnewline
 init\_spectrum\_from\_file & C & ''       &      & path and name of initial condition file &   init\_mode=1
\tabularnewline
 lskip\_inv\_post\_op    & L    & .FALSE.  &      & The initial condition file contains $S(\omega)$ (.FALSE.) or $S(f)$ (.TRUE.) &   init\_mode=1
\tabularnewline
\end{longtab}
...
%Parameter &Type& Default   & Unit& Description&                                                      Scope
 ...
 Tlength   & I  & 10800     &  s  & Length of time series for max. wave height calculation & \tabularnewline
...
peak\_lat & R & -60.0        & degree & latitude of wind peak value & ltestcase=.TRUE. \tabularnewline
peak\_lon & R & -140.0       & degree & longitude of wind peak value & ltestcase=.TRUE. \tabularnewline
peak\_wsp10 & R & 25.0       & m/s    & peak value of 10m wind speed at (peak\_lat,peak\_lon) & ltestcase=.TRUE. \tabularnewline
dir\_wsp10  & R & 45.0       & degree & wind direction measured clockwise from true north & ltestcase=.TRUE. \tabularnewline
