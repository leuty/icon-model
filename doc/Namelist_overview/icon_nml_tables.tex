...
4,5,6,7: Two-moment microphysics by A. Seifert, further configuration possible in namelist \texttt{/twomom\_mcrph\_nml/}\\
...
0&
 &
0: ice nucleating particles concentration defined by temperature using Cooper (1987) formula \\
1: ice nucleating particles concentration defined by temperature and dust concentration using DeMott (2015) formula; requires irad\_aero=6, 7 or 8 \\
\tabularnewline
...
lexpcor &
L                &     .FALSE.      & &
Explicit corrections of implicitly calculated vertical diffusion of non-conservative scalars 
that are involved in sub grid condensation processes (inactive). &
\tabularnewline

%\hline
lnonloc &
L                &     .FALSE.      & &
Nonlocal calculation of vertical gradients used for turbul. diff. (inactive). &
\tabularnewline
...
lprfcor &
L                &     .FALSE.      & &
Using the profile values of the lowest main level instead of the mean value of the lowest layer 
for surface flux calculations (inactive). &
\tabularnewline
