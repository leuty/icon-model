...
.FALSE.&
&
.TRUE.: scaling of external (MODIS) cdnc with a time varying 2-dimensional factor derived from the simple plume scheme. It is advisable to turn the scaling off at least for the years 2000-2020. &
...
0&
 &
0: off \\
1: simple coupling between autoconversion and Tegen aerosol climatology; requires irad\_aero=6 or 7 &
\tabularnewline
...
0.0&
&
prefactor in RH-dependent detrainment profile, recommended range is $1.7$ to $1.9$ &
run\_nml:iforcing = inwp;
\tabularnewline
