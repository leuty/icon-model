...
model\_components&
C(3)& '' '', '' '', '' '' & &
Model components. Currently, the following options are available:\\
{\textasteriskcentered} ''icon-nwp''\\
{\textasteriskcentered} ''icon-nwp'', ''art-nwp''\\
{\textasteriskcentered} ''icon-nwp'', ''ocean-nwp''\\
{\textasteriskcentered} ''icon-nwp'', ''art-nwp'', ''ocean-nwp''\\
