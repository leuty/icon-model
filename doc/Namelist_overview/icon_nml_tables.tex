...
R(rbf\_coeffs\_ROOT\_dom<i\_dom>.nc) instead of reconstructing. Coefficients
...
R(rbf\_coeffs\_ROOT\_dom<i\_dom>.nc).&
\tabularnewline
...
0&
 &
0: off \\
1: simple coupling between autoconversion and Tegen aerosol climatology; requires irad\_aero=6, 7 or 9 \\
3: use cloud-droplet number climatology from external parameter file. External parameter files containing cloud-droplet number climatology can be generated with extpar code from version rc\_5.14 \\
