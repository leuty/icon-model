...
-1: take over the setting of gribout\_nml:lgribout\_compress\_ccsds \\
0: (CDI\_COMPRESS\_NONE): No (special) data compression \\
1: (CDI\_COMPRESS\_SZIP): CCSDS compression &
filetype=2
\tabularnewline
