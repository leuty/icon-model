...
! *** provisional dummy GRIB parameters until final triplets are available ***
    IF (icpl_da_sfcevap >= 5) THEN
      ...
      grib2_desc = grib2_var(0, 254, 10, ibits, GRID_UNSTRUCTURED, GRID_CELL) ! DUMMY_10
      ...
      grib2_desc = grib2_var(0, 254, 11, ibits, GRID_UNSTRUCTURED, GRID_CELL) ! DUMMY_11
