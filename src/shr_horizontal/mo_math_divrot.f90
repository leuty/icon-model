...
SUBROUTINE recon_lsq_cell_l( p_cc, ptr_patch, ptr_int_lsq, p_coeff, &
  ...
  CALL recon_lsq_cell_l_lib( p_cc, ptr_int_lsq%lsq_idx_c, ptr_int_lsq%lsq_blk_c, &
    ...
    &                        ptr_patch%nlev, slev, elev, nproma, l_consv, lacc=i_am_accel_node, acc_async=opt_acc_async )
...
SUBROUTINE recon_lsq_cell_q( p_cc, ptr_patch, ptr_int_lsq, p_coeff, &
  ...
  CALL recon_lsq_cell_q_lib( p_cc, ptr_int_lsq%lsq_idx_c, ptr_int_lsq%lsq_blk_c, &
    ...
    &                        i_startblk, i_endblk, i_startidx_in, i_endidx_in, &
    &                        ptr_patch%nlev, slev, elev, nproma, ptr_patch%id, lsq_high_set%dim_c, l_limited_area, lacc=i_am_accel_node)
...
SUBROUTINE div_avg( vec_e, ptr_patch, ptr_int, avg_coeff, div_vec_c,    &
  ...
  CALL div_avg_lib( vec_e, ptr_patch%cells%neighbor_idx, ptr_patch%cells%neighbor_blk, &
    ...
    &               ptr_patch%nlev, ptr_patch%nblks_c, ptr_patch%id, l_limited_area, slev, elev, nproma, l2fields, lacc=i_am_accel_node) 
