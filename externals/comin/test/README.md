...
necessary things like the `replay_tool`, which is a dummy host code using ComIn.
...
## `parallel`
This test tests the parallel execution of the replay_tool with a simple plugin attached.
