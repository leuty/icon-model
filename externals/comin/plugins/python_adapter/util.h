...
// format characters - see:
// https://docs.python.org/3/library/struct.html#format-characters
template <class T> const char* get_format_char();

template <> inline const char* get_format_char<double>() { return "d"; }
template <> inline const char* get_format_char<float>() { return "f"; }
template <> inline const char* get_format_char<int>() { return "i"; }
template <> inline const char* get_format_char<int8_t>() { return "i1"; }

template <class T>
void fill_buffer(Py_buffer* buffer, void* mem, int* shape, int ndims,
                 int readonly = 1) {
  buffer->obj = NULL;
  buffer->buf = (void*)mem;
  buffer->len = sizeof(T);
