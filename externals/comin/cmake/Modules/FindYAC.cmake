...
if(YAXT_FOUND AND NetCDF_FOUND AND LAPACK_FOUND)
  ...
  if(YAC_FOUND)
    if(NOT TARGET YAC::YAC)
      add_library(YAC::YAC STATIC IMPORTED)
      target_include_directories(YAC::YAC INTERFACE
        "${YAC_C_INCLUDE_DIR}"
        "${YAC_FORTRAN_INCLUDE_DIR}"
      )
      set_property(TARGET YAC::YAC PROPERTY
        IMPORTED_LOCATION "${YAC_C_LIBRARY}"
      )
      target_link_options(YAC::YAC BEFORE INTERFACE
        "-Wl,--export-dynamic-symbol=yac_*"
      )
      target_link_libraries(YAC::YAC INTERFACE
        "${YAC_C_MTIME_LIBRARY}"
        YAXT::YAXT_C
        NetCDF::NetCDF_C
        MPI::MPI_C
