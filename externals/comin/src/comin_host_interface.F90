...
MODULE comin_host_interface
  ...
  USE comin_variable_types,    ONLY: t_comin_var_handle, t_comin_var_descriptor, &
    &                                t_comin_request_item
  USE comin_variable,          ONLY: comin_var_list_finalize, comin_var_descr_list_finalize,       &
    &                                comin_var_get_descr_list_head, comin_var_get_descr_list_next, &
    &                                comin_var_list_append, comin_request_get_list,                &
    &                                comin_var_set_sync_device_mem,                                &
    &                                comin_var_set_cptr,                                           &
    &                                comin_var_request_list_finalize,                              &
    &                                comin_var_descr_list_iterator_delete,                         &
    &                                comin_var_get_descr_list_var_desc, comin_var_set_sync_halo
  USE comin_metadata,          ONLY: comin_metadata_set => comin_metadata_set_host, &
    &                                comin_metadata_get_typeid, comin_metadata_get_iterator, &
    &                                comin_metadata_get_or, comin_metadata_get
  ...
  USE comin_ftnlist_ifc,          ONLY: comin_ftnlist_is_end, comin_ftnlist_iterator_begin, &
...
#include "comin_global.inc"
  ...
  PUBLIC :: COMIN_METADATA_TYPEID_UNDEFINED, &
    ...
    &       COMIN_METADATA_TYPEID_CHARACTER, &
    &       COMIN_METADATA_TYPEID_LOGICAL
  PUBLIC :: COMIN_VAR_DATATYPE_DOUBLE, COMIN_VAR_DATATYPE_FLOAT, COMIN_VAR_DATATYPE_INT
  ...
  ! From comin_variable:
  PUBLIC :: comin_var_list_finalize
  PUBLIC :: comin_var_request_list_finalize
  PUBLIC :: t_comin_var_handle, t_comin_var_descriptor,                       &
    &       comin_var_list_append
  PUBLIC :: comin_request_get_list
  PUBLIC :: comin_var_set_sync_device_mem
  PUBLIC :: comin_var_get_descr_list_head
  PUBLIC :: comin_var_get_descr_list_next
  PUBLIC :: comin_var_get_descr_list_var_desc
  PUBLIC :: comin_var_descr_list_iterator_delete
  PUBLIC :: comin_var_descr_list_finalize
  PUBLIC :: t_comin_request_item
  ...
  ! From comin_ftnlist_ifc
  PUBLIC :: comin_ftnlist_is_end
  PUBLIC :: comin_ftnlist_iterator_begin
  PUBLIC :: comin_ftnlist_iterator_delete
  PUBLIC :: comin_ftnlist_iterator_next
  PUBLIC :: comin_ftnlist_iterator_value
