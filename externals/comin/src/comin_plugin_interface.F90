...
MODULE comin_plugin_interface
  ...
  USE comin_variable_types,    ONLY: t_comin_var_descriptor, t_comin_var_handle
  ...
  USE comin_errhandler,        ONLY: comin_plugin_finish, comin_error_get_message,           &
    ...
    &                                comin_error_get, comin_error_reset
  USE comin_errhandler_constants, ONLY: COMIN_SUCCESS
  USE comin_print,           ONLY: comin_print_debug, comin_print_info, comin_print_warning
...
#include "comin_global.inc"
  ...
  ! From comin_variable:
  PUBLIC :: comin_var_get, t_comin_var_descriptor, t_comin_var_handle
  ...
  PUBLIC :: comin_descrdata_get_edge_indices, comin_descrdata_get_vert_indices
  ...
  PUBLIC :: EP_SECONDARY_CONSTRUCTOR,     &
    ...
    &       COMIN_HGRID_UNSTRUCTURED_EDGE,  &
    &       COMIN_HGRID_UNSTRUCTURED_VERTEX
  PUBLIC :: COMIN_FLAG_READ, COMIN_FLAG_WRITE, COMIN_FLAG_DEVICE, COMIN_FLAG_SYNC_HALO
  ...
  PUBLIC :: comin_error_set_errors_return, comin_error_get, comin_error_reset

  ! From comin_errhandler_constants
  PUBLIC :: COMIN_SUCCESS

  ! From comin_print
  PUBLIC :: comin_print_debug, comin_print_info, comin_print_warning
