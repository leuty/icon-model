...
MODULE comin_state
  ...
  USE comin_callback_types,  ONLY:  t_comin_callback_context
  ...
  USE comin_variable_types,  ONLY:  t_comin_var_list_context,       &
    &                               comin_var_sync_device_mem_fct,  &
    &                               comin_var_sync_halo_fct
...
CONTAINS
  ...
  !! @ingroup host_interface
  FUNCTION comin_setup_get_verbosity_level()
    INTEGER :: comin_setup_get_verbosity_level
