...
extern "C"{
  ...
  void comin_descrdata_get_domain_number_of_grid_used(int jg, const int** number_of_grid_used, int* arr_size);
  ...
  void comin_descrdata_get_domain_cells_child_idx(int jg, const int** child_idx, int* arr_size);
  void comin_descrdata_get_domain_cells_child_blk(int jg, const int** child_blk, int* arr_size);
  ...
  void comin_descrdata_get_domain_edges_child_idx(int jg, const int** child_idx, int* arr_size);
  void comin_descrdata_get_domain_edges_child_blk(int jg, const int** child_blk, int* arr_size);
