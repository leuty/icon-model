...
- class ComInError
- EntryPoint `EP_ATM_ADVECTION_AFTER`
- EntryPoint `EP_ATM_ADVECTION_BEFORE`
- EntryPoint `EP_ATM_CHECKPOINT_AFTER`
- EntryPoint `EP_ATM_CHECKPOINT_BEFORE`
- EntryPoint `EP_ATM_CONVECTION_AFTER`
- EntryPoint `EP_ATM_CONVECTION_BEFORE`
- EntryPoint `EP_ATM_GWDRAG_AFTER`
- EntryPoint `EP_ATM_GWDRAG_BEFORE`
- EntryPoint `EP_ATM_INIT_FINALIZE`
- EntryPoint `EP_ATM_INTEGRATE_AFTER`
- EntryPoint `EP_ATM_INTEGRATE_BEFORE`
- EntryPoint `EP_ATM_INTEGRATE_END`
- EntryPoint `EP_ATM_INTEGRATE_START`
- EntryPoint `EP_ATM_MICROPHYSICS_AFTER`
- EntryPoint `EP_ATM_MICROPHYSICS_BEFORE`
- EntryPoint `EP_ATM_NUDGING_AFTER`
- EntryPoint `EP_ATM_NUDGING_BEFORE`
- EntryPoint `EP_ATM_PHYSICS_AFTER`
- EntryPoint `EP_ATM_PHYSICS_BEFORE`
- EntryPoint `EP_ATM_RADHEAT_AFTER`
- EntryPoint `EP_ATM_RADHEAT_BEFORE`
- EntryPoint `EP_ATM_RADIATION_AFTER`
- EntryPoint `EP_ATM_RADIATION_BEFORE`
- EntryPoint `EP_ATM_SURFACE_AFTER`
- EntryPoint `EP_ATM_SURFACE_BEFORE`
- EntryPoint `EP_ATM_TIMELOOP_AFTER`
- EntryPoint `EP_ATM_TIMELOOP_BEFORE`
- EntryPoint `EP_ATM_TIMELOOP_END`
- EntryPoint `EP_ATM_TIMELOOP_START`
- EntryPoint `EP_ATM_TURBULENCE_AFTER`
- EntryPoint `EP_ATM_TURBULENCE_BEFORE`
- EntryPoint `EP_ATM_WRITE_OUTPUT_AFTER`
- EntryPoint `EP_ATM_WRITE_OUTPUT_BEFORE`
- EntryPoint `EP_ATM_YAC_DEFCOMP_AFTER`
- EntryPoint `EP_ATM_YAC_DEFCOMP_BEFORE`
- EntryPoint `EP_ATM_YAC_ENDDEF_AFTER`
- EntryPoint `EP_ATM_YAC_ENDDEF_BEFORE`
- EntryPoint `EP_ATM_YAC_SYNCDEF_AFTER`
- EntryPoint `EP_ATM_YAC_SYNCDEF_BEFORE`
- EntryPoint `EP_DESTRUCTOR`
- EntryPoint `EP_FINISH`
- EntryPoint `EP_SECONDARY_CONSTRUCTOR`
...
- callable `print_debug`: C function signature: `void comin_print_debug(const char* msg)`
- callable `print_info`: C function signature: `void comin_print_info(const char* msg)`
- callable `print_warning`: C function signature: `void comin_print_warning(const char* msg)`
