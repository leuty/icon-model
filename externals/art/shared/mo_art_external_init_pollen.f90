...
!>
  ...
  DO ip = 1, p_pollen_prop%npollen_used
    ...
    CASE('pollbetu')
      ...
      ! Parameter for bursting into SPP
      this_pollen_table%spp_rh_thresh    = 0.845_wp !< calculated after Zhou
                                                    !< 2015 by assuming 
                                                    !< expansion of 1 um
      this_pollen_table%spp_rh_max       = 0.96_wp  !< Taylor 2004
      this_pollen_table%spp_delta_r      = 1e-6_wp  !< Zhou 2015
    ...
    CASE('pollambr')
      ...
      ! Parameter for bursting into SPP
      this_pollen_table%spp_rh_thresh    = 2._wp  !< essentially disabling bursting
      this_pollen_table%spp_rh_max       = 1._wp  !< 
      this_pollen_table%spp_delta_r      = 0._wp  !<
