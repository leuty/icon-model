...
!>
  ...
  IF (.NOT. isRestart()) THEN
    ...
    IF (art_indices%iTRCCl4         /= 0)     tracer(:,:,:,art_indices%iTRCCl4)       = 8.91e-11_wp
    IF (art_indices%iTRCFCl3        /= 0)     tracer(:,:,:,art_indices%iTRCFCl3)      = 2.43e-10_wp
    IF (art_indices%iTRCF2Cl2       /= 0)     tracer(:,:,:,art_indices%iTRCF2Cl2)     = 7.87e-10_wp
    ...
    IF (art_indices%iTR_gol    /= 0)   tracer(:,:,:,art_indices%iTR_gol)    = 0.00_wp
    IF (art_indices%iTR_nest   /= 0)   tracer(:,:,:,art_indices%iTR_nest)   = 0.00_wp
    IF (art_indices%iTR_phto   /= 0)   tracer(:,:,:,art_indices%iTR_phto)   = 0.00_wp
    IF (art_indices%iTR_phnwp  /= 0)   tracer(:,:,:,art_indices%iTR_phnwp)  = 0.00_wp
    IF (art_indices%iTR_phnep  /= 0)   tracer(:,:,:,art_indices%iTR_phnep)  = 0.00_wp
    IF (art_indices%iTR_phnao  /= 0)   tracer(:,:,:,art_indices%iTR_phnao)  = 0.00_wp
    IF (art_indices%iTR_phnpo  /= 0)   tracer(:,:,:,art_indices%iTR_phnpo)  = 0.00_wp
    IF (art_indices%iTR_phnin  /= 0)   tracer(:,:,:,art_indices%iTR_phnin)  = 0.00_wp
    IF (art_indices%iTR_phsin  /= 0)   tracer(:,:,:,art_indices%iTR_phsin)  = 0.00_wp
    IF (art_indices%iTR_phech  /= 0)   tracer(:,:,:,art_indices%iTR_phech)  = 0.00_wp
    IF (art_indices%iTR_phsea  /= 0)   tracer(:,:,:,art_indices%iTR_phsea)  = 0.00_wp
    IF (art_indices%iTR_pheur  /= 0)   tracer(:,:,:,art_indices%iTR_pheur)  = 0.00_wp
    IF (art_indices%iTR_phmea  /= 0)   tracer(:,:,:,art_indices%iTR_phmea)  = 0.00_wp
    IF (art_indices%iTR_phnaf  /= 0)   tracer(:,:,:,art_indices%iTR_phnaf)  = 0.00_wp
    IF (art_indices%iTR_phnam  /= 0)   tracer(:,:,:,art_indices%iTR_phnam)  = 0.00_wp
    IF (art_indices%iTR_phcas  /= 0)   tracer(:,:,:,art_indices%iTR_phcas)  = 0.00_wp
    IF (art_indices%iTR_ascci_eur  /= 0)   tracer(:,:,:,art_indices%iTR_ascci_eur)  = 0.00_wp
    IF (art_indices%iTR_ascci_nam  /= 0)   tracer(:,:,:,art_indices%iTR_ascci_nam)  = 0.00_wp
    IF (art_indices%iTR_ascci_cas  /= 0)   tracer(:,:,:,art_indices%iTR_ascci_cas)  = 0.00_wp
    IF (art_indices%iTR_ascci_nwp  /= 0)   tracer(:,:,:,art_indices%iTR_ascci_nwp)  = 0.00_wp
    IF (art_indices%iTR_ascci_nep  /= 0)   tracer(:,:,:,art_indices%iTR_ascci_nep)  = 0.00_wp
    IF (art_indices%iTR_ascci_nat  /= 0)   tracer(:,:,:,art_indices%iTR_ascci_nat)  = 0.00_wp
    IF (art_indices%iTR_ascci_tro  /= 0)   tracer(:,:,:,art_indices%iTR_ascci_tro)  = 0.00_wp
    IF (art_indices%iTR_ascci_arc  /= 0)   tracer(:,:,:,art_indices%iTR_ascci_arc)  = 0.00_wp
...
!>
  ...
  CALL p_art_data(jg)%dict_tracer%get('TRO3_V3',art_indices%iTRO3_V3,ierror)
    IF (ierror /= SUCCESS) art_indices%iTRO3_V3       = 0  
  ...
  CALL p_art_data(jg)%dict_tracer%get('TRCCl4',art_indices%iTRCCl4,ierror)
    IF (ierror /= SUCCESS) art_indices%iTRCCl4 = 0
  ...
  CALL p_art_data(jg)%dict_tracer%get('TRClO',art_indices%iTRClO,ierror)
    IF (ierror /= SUCCESS) art_indices%iTRClO = 0
  ...
  CALL get_regio_tracer_idx(jg,'TR_gol',art_indices%iTR_gol)
  CALL get_regio_tracer_idx(jg,'TR_nest',art_indices%iTR_nest)
  CALL get_regio_tracer_idx(jg,'TR_phto',art_indices%iTR_phto)
  CALL get_regio_tracer_idx(jg,'TR_phnwp',art_indices%iTR_phnwp)
  CALL get_regio_tracer_idx(jg,'TR_phnep',art_indices%iTR_phnep)
  CALL get_regio_tracer_idx(jg,'TR_phnao',art_indices%iTR_phnao)
  CALL get_regio_tracer_idx(jg,'TR_phnpo',art_indices%iTR_phnpo)
  CALL get_regio_tracer_idx(jg,'TR_phnin',art_indices%iTR_phnin)
  CALL get_regio_tracer_idx(jg,'TR_phsin',art_indices%iTR_phsin)
  CALL get_regio_tracer_idx(jg,'TR_phech',art_indices%iTR_phech)
  CALL get_regio_tracer_idx(jg,'TR_phsea',art_indices%iTR_phsea)
  CALL get_regio_tracer_idx(jg,'TR_pheur',art_indices%iTR_pheur)
  CALL get_regio_tracer_idx(jg,'TR_phmea',art_indices%iTR_phmea)
  CALL get_regio_tracer_idx(jg,'TR_phnaf',art_indices%iTR_phnaf)
  CALL get_regio_tracer_idx(jg,'TR_phnam',art_indices%iTR_phnam)
  CALL get_regio_tracer_idx(jg,'TR_phcas',art_indices%iTR_phcas)
  CALL get_regio_tracer_idx(jg,'TR_ascci_eur',art_indices%iTR_ascci_eur)
  CALL get_regio_tracer_idx(jg,'TR_ascci_nam',art_indices%iTR_ascci_nam)
  CALL get_regio_tracer_idx(jg,'TR_ascci_cas',art_indices%iTR_ascci_cas)
  CALL get_regio_tracer_idx(jg,'TR_ascci_nwp',art_indices%iTR_ascci_nwp)
  CALL get_regio_tracer_idx(jg,'TR_ascci_nep',art_indices%iTR_ascci_nep)
  CALL get_regio_tracer_idx(jg,'TR_ascci_nat',art_indices%iTR_ascci_nat)
  CALL get_regio_tracer_idx(jg,'TR_ascci_tro',art_indices%iTR_ascci_tro)
  CALL get_regio_tracer_idx(jg,'TR_ascci_arc',art_indices%iTR_ascci_arc)
