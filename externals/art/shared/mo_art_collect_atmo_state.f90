...
#ifdef _OPENACC
      CALL finish('mo_art_collect_atmo_state:art_update_atmo_state_nwp',  &
...
#ifdef _OPENACC
      CALL finish('mo_art_collect_atmo_state:art_init_tracer_values',  &
...
#ifdef _OPENACC
        CALL finish('mo_art_collect_atmo_state:art_init_tracer_values',  &
          &  'iart_init_gas = 1 is not (yet) supported on GPU')
#endif
...
#ifdef _OPENACC
        CALL finish('mo_art_collect_atmo_state:art_init_tracer_values',  &
          &  'iart_init_gas = 4 is not (yet) supported on GPU')
#endif
...
#ifdef _OPENACC
        CALL finish('mo_art_collect_atmo_state:art_init_tracer_values',  &
          &  'iart_init_gas = 5 is not (yet) supported on GPU')
#endif
...
#ifdef _OPENACC
        CALL finish('mo_art_collect_atmo_state:art_init_tracer_values',  &
          &  'iart_init_aero = 1 is not (yet) supported on GPU')
#endif
...
#ifdef _OPENACC
        CALL finish('mo_art_collect_atmo_state:art_init_tracer_values',  &
          &  'iart_init_aero = 2 is not (yet) supported on GPU')
#endif
...
#ifdef _OPENACC
        CALL finish('mo_art_collect_atmo_state:art_init_tracer_values',  &
          &  'iart_init_aero = 5 is not (yet) supported on GPU')
#endif
...
#ifdef _OPENACC
        CALL finish('mo_art_collect_atmo_state:art_init_tracer_values',  &
          &  'iart_init_aero = 6 is not (yet) supported on GPU')
#endif
...
!>
  ...
  IF (art_config(jg)%lart_chem) THEN
#ifdef _OPENACC
    CALL finish('mo_art_collect_atmo_state:art_init_tracer_values_nwp',  &
    ...
    IF (art_indices%iTRO3_V3  /= 0) THEN
      tracer(:,:,:,art_indices%iTRO3_V3) = art_atmo%o3_clim(:,:,:) * amd / amo3
    ENDIF
