...
! ICON
  ...
  PUBLIC :: IART_ACC_WETDEPO_GSCP, IART_ACC_WETDEPO_CON, IART_ACC_WETDEPO_RRSFC, IART_ACC_WETDEPO_GAS
  PUBLIC :: IART_LINOZ_ANA, IART_CHEM_NO
  PUBLIC :: IART_POLARCHEM, IART_LINOZ_LT
  PUBLIC :: IART_SIMNOY_SEDI
  PUBLIC :: IART_SIMNOY_PRES, IART_SIMNOY_WMO, IART_SIMNOY_EXTP, IART_SIMNOY_UBC, IART_SIMNOY_NOUBC
