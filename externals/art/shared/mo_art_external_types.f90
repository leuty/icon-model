...
! ART
  ...
  TYPE t_art_pollen_table
    ...
    ! Subpollen particle generation parameters
    REAL(wp)                ::  &
      &  spp_rh_thresh,         &     !< relative humidity at which pollen burst can occur
      &  spp_rh_max,            &     !< relative humidity corresponding to 
                                      !<   pollen wall strength
      &  spp_delta_r                  !< radius expansion (before bursting)
