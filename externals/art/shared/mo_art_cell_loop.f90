...
MODULE mo_art_cell_loop
  ...
  USE mo_art_chem_types_param, ONLY: t_chem_meta_lt, t_chem_meta_linoz, t_chem_meta_linozv3,&
                                 &   t_chem_meta_simnoy
  ...
  IMPLICIT NONE
  PRIVATE
  PUBLIC :: art_loop_cell_tracer, art_loop_cell_tracer_td, art_loop_cell_tracer_td2, &
            & art_loop_cell_tracer_nonproma
  ...
  INTERFACE art_loop_cell_tracer
   ...
   MODULE PROCEDURE art_loop_cell_tracer_linozv3
   MODULE PROCEDURE art_loop_cell_tracer_simnoy
  END INTERFACE art_loop_cell_tracer

  INTERFACE art_loop_cell_tracer_nonproma
   MODULE PROCEDURE art_loop_cell_tracer_nonproma_simnoy
  END INTERFACE art_loop_cell_tracer_nonproma
  ...
  INTERFACE art_loop_cell_tracer_td
   ...
   MODULE PROCEDURE art_loop_cell_tracer_td_linozv3
   MODULE PROCEDURE art_loop_cell_tracer_td_simnoy
  END INTERFACE art_loop_cell_tracer_td

  INTERFACE art_loop_cell_tracer_td2
    MODULE PROCEDURE art_loop_cell_tracer_td2_linozv3
    MODULE PROCEDURE art_loop_cell_tracer_td2_simnoy
  END INTERFACE art_loop_cell_tracer_td2
...
!$OMP END PARALLEL DO 
  ...
  SUBROUTINE art_loop_cell_tracer_linozv3(jg  ,tracer,&
       &                   routine)

    ! Arguments
    !
    INTEGER, INTENT(in)                 :: jg
    TYPE(t_chem_meta_linozv3), INTENT(inout) :: tracer
...
!$OMP END PARALLEL DO 
  ...
  END SUBROUTINE art_loop_cell_tracer_linozv3                                                                                                                 
...
!$OMP END PARALLEL DO 
  ...
  SUBROUTINE art_loop_cell_tracer_nonproma_simnoy(jg  ,tracer,&
    &                   routine)
...
!$OMP PARALLEL DO PRIVATE(jb,jcs,jce)
 DO jb = art_atmo%i_startblk,art_atmo%i_endblk
    ...
    !
    CALL routine(jg,jb,jcs,jce ,&
         &       art_atmo%nlev,tracer)
    !
 END DO
!$OMP END PARALLEL DO 

END SUBROUTINE art_loop_cell_tracer_nonproma_simnoy
...
!$OMP END PARALLEL DO 
  ...
  END SUBROUTINE art_loop_cell_tracer_td_linoz
   ...
   SUBROUTINE art_loop_cell_tracer_td_linozv3(jg  ,tracer,&
       &                   current_date, &
       &                   p_dtime, &
       &                   routine)
...
!$OMP END PARALLEL DO 
  ...
  END SUBROUTINE art_loop_cell_tracer_td_linozv3

  SUBROUTINE art_loop_cell_tracer_td2_linozv3(jg  ,tracer,&
    &                   p_dtime, &
    &                   routine)
...
END SUBROUTINE art_loop_cell_tracer_td2_linozv3
...
!$OMP END PARALLEL DO 
  ...
  SUBROUTINE art_loop_cell_tracer_td2_simnoy(jg  ,tracer,&
    &                   p_dtime, &
    &                   routine)
...
END SUBROUTINE art_loop_cell_tracer_td2_simnoy
