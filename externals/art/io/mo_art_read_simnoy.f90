...
! ---------------------------------
  ...
  INTEGER, PARAMETER    :: lparm2 = 31        ! heights
  ...
  REAL(wp), DIMENSION(lparm2,kparm,mparm,nparm)   :: tparm_noy2
  
  
  PUBLIC :: n2onoy_read, tparm_noy,tparm_noy2
  PUBLIC :: lparm,lparm2, kparm, mparm, nparm, lparm_min, lparm_dist
...
!>
  ...
  n2onoyinitfile='Simnoy2002_v2.dat'
  ...
  ELSE
    ...
    DO n=2,2
      ...
      DO m=1,mparm
        DO k=1,kparm
          READ(61,902) (tparm_noy2(l,k,m,n),l=1,lparm2)
        ENDDO
      ENDDO
    ENDDO
