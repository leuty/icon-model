...
MODULE mo_art_OH_chem_predcorr_method
  ...
  USE mo_art_chemical_constants,        ONLY: n2_frac, o2_frac
  ...
  DO jb = art_atmo%i_startblk, art_atmo%i_endblk
    ...
    DO jk=1,art_atmo%nlev
      DO jc=i_startidx,i_endidx
        ...
        N2_Nconc   =  n2_frac * art_chem%vmr2Nconc(jc,jk,jb)
        O2_Nconc   =  o2_frac * art_chem%vmr2Nconc(jc,jk,jb)
...
SUBROUTINE art_calculate_O1D_number_concentration(jg,OH_chem_meta,temp,J_O3)
!<
! SUBROUTINE art_calculate_O1D_number_concentration
! This subroutine calculates diagnostically the number concentration of O1D 
! Part of Module: mo_art_OH_chem_predcorr_method
! Author: Khompat Satitkovitchai, KIT
! Initial Release: 2024-11-26
! Modifications:
!>
  IMPLICIT NONE
  INTEGER, INTENT(in) :: &
  ...
  DO jb = art_atmo%i_startblk, art_atmo%i_endblk
    ...
    DO jk=1,art_atmo%nlev
      DO jc=i_startidx,i_endidx
        ...
        OH_chem_meta%O1D_Nconc(jc,jk,jb) = J_O3(jc,jk,jb) * O3_Nconc &
                     &  / (k_O1D_O2 * O2_Nconc + k_O1D_N2 * N2_Nconc + k_O1D_H2O * H2O_Nconc)
      END DO
    END DO
  END DO

END SUBROUTINE art_calculate_O1D_number_concentration
